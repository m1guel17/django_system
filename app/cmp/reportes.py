...
from cmp.models import ComprasEnc, ComprasDet
...
def imprimir_compra(request, compra_id):
    ...
    if enc:
        detalle = ComprasDet.objects.filter(compra__id=compra_id) # Filter by a field of the related ComprasEnc (joins required).
